...
if (existingCafes.count === 0) {
  ...
  console.log('Username: gamezone_owner, Password: password123');
  console.log('Username: cyberknights_owner, Password: password123');
  console.log('Username: pixelparadise_owner, Password: password123');
